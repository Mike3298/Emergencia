...
DefaultTableModel ModeloTabla = new DefaultTableModel();    
    ...
    public DefaultTableModel ListarPacientes()
    {
        ...
        {
           this.ModeloTabla.addRow(new Object[]{MiListaDePacientes.getApellidos(),MiListaDePacientes.getNombre(),MiListaDePacientes.getTelefono(),MiListaDePacientes.getGravedad()});
        }
